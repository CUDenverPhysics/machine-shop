/**
  ...
  Modified for CU Denver Physics ProtoTRAK SMX DPM2 by Kristopher Bunker on 06/08/2018
...
description = "CU Denver Physics ProtoTRAK SMX";
...
longDescription = "Milling Post for CU Denver Physics ProtoTRAK SMX DPM2.";
